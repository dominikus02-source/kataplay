          ...
          children: [
            ...
            if (pillText != null)
              Container(
                ...
                decoration: BoxDecoration(
                  color: (pillColor ?? AppColors.primary).withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
                  pillText!,
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: const [
                Icon(Icons.logout_rounded, color: AppColors.wrong, size: 16),
                SizedBox(width: 6),
                Text(
                  'Keluar',
                  style: TextStyle(
